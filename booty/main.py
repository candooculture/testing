...
def render_report_html(data):
    ...
    <body>
      ...
      <!-- TOP CTA -->
      <div class="cta">
        <p>Ready to take action? <a href="https://your-booking-link.com" target="_blank">Book a 15-minute strategy call</a> to unpack your results.</p>
      </div>
      ...
      <!-- BOTTOM CTA -->
      <div class="cta">
        <p>Want to dive deeper? <a href="https://your-booking-link.com" target="_blank">Book a free consult</a> with our team.</p>
      </div>
